...
首次使用 v0.2 时，在 Neo4j Browser 中执行 [`graph_migrations/v0.2_vertex_task.cypher`](graph_migrations/v0.2_vertex_task.cypher)。该迁移会新增“求顶点”的 Task 与策略路径，并为操作说明补充可由 MathJax 渲染的行内公式。
